...
{
    /// <summary>
    /// Логика взаимодействия для AddWorking.xaml
    /// </summary>
    ...
    public partial class AddWorking : Window
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddWorking"/> class.
        /// </summary>
        /// <param name="mainWindow">The main window.</param>
        public AddWorking(MainWindow mainWindow)
        {
        ...
        private void Button_Click_2(object sender, RoutedEventArgs e)
        {
            try
            {
                if (mainWindow.listOfPeople.IsInfo(surname.Text, data.Text, status.Text, place.Text, "") == false) MessageBox.Show("Некорректные данные");
